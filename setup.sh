...
if [ "" = "$PKG_OK" ]; then
  ...
  echo -e "[ ${BGreen}INFO${NC} ] Done installed"
fi
...
wget https://raw.githubusercontent.com/NevermoreSSH/v4/main/cf.sh && chmod +x cf.sh && ./cf.sh
elif test $dns -eq 2; then
read -rp "Enter Your Domain / masukkan domain : " dom
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/NevermoreSSH/Parry_All/master/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
# install xray
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear 
wget https://raw.githubusercontent.com/NevermoreSSH/Parry_All/master/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/NevermoreSSH/Parry_All/master/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
#install SET-BR
echo -e "\e[0;32mINSTALLING SET-BR...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/NevermoreSSH/Parry_All/main/set-br.sh && chmod +x set-br.sh && ./set-br.sh
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/NevermoreSSH/Parry_All/master/menu/versi  )
